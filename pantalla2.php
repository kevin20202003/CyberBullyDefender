...
<body
  ...
  <div id="pantalla2">
    ...
    <h3 class="tituintimida">Temas de asesoramiento empresarial a tu disposición</h3>
      ...
      <div class="container-grid">
        ...
        <div class="contenedores2">
          ...
          while ($fila = mysqli_fetch_assoc($resultados_titulos)) {
                ...
                <div class='infoblog'>
                    <div class='blog-details3'>
                        ...
                        <div class='tituloblog'>
                            ...
                            <h5><a href='#f' style='color: white; text-decoration: none;'>$titulo</a></h5>
                        </div>
                        ...
                        <div class='blogdescripcion'>
                            <p style='text-align: justify;'>$descripcion
            ...
            <!-- Contenedor grande -->
            <div id='contenedorGrandeempre$i' class='overlay3' onclick='cerrarContenedorGrande1($i)' style='text-align:justify; height: auto; display:none;'>
                <div class='advertisement2'>
                    <h2 style='color: #26888f;'>$titulo</h2>
                    <p class='conm' style='text-align: justify;'>$descri2</p>
