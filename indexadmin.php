    ...
    <div id="pantalla1" class="videofondo">
        ...
        <section class="ojala">
            ...
            <div class="btn200">
                ...
                <a href="superadmins.php" class="login-button" >Agregar SuperUser</a>
                <br><br>
                <a href="eliminar_superuser.php" class="login-button" >Eliminar SuperUser</a>
            </div>
            <div class="cyber">
