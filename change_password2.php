    ...
    <div class="row full-height justify-content-center">
      <div class="col-12 text-center align-self-center py-5">
        <div class="section pb-5 pt-5 pt-sm-2 text-center">
          <h1 class="mb-0 pb-3"><span>Change Password</span></h1>
            ...
            <form method="post" action="message2.php">
                  <div class="section text-center">
                    <div class="form-group mt-2">
                      <input type="password" class="form-style" placeholder="Enter New Password" name="new_password" id="new_password">
                      <i class="input-icon uil uil-lock-alt"></i>
                    </div>
                    <div class="form-group mt-2">
                      <input type="password" class="form-style" placeholder="Repeat Password" name="confirm_password" id="confirm_password">
                      <i class="input-icon uil uil-lock-alt"></i>
                    </div>
                    <button type="submit" class="btn mt-4" name="change_password">Change Password</button>
                      </div>
                      </form>
                    </div>
                </div>
